    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <p class="text-primary fw-bold m-0">Bank Syariah Indonesia</p>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <span id="noRek" class="fw-bold text-success fs-5">12345678901</span>

                <button onclick="copyRekening('noRek')">Salin</button>
            </div>
        </div>
