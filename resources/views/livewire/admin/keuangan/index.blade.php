<div>
  ...
  <div class="container-fluid">
    ...
    <div class="row mb-3">
      <div class="col-12">
        <h2 class="m-0 text-primary"><i class="fas fa-hand-holding-usd"></i> Input Pemasukan</h2>
      </div>
    </div>
      ...
      <div >
        <div>
            <div class="d-flex justify-content-between">
                <div>
                   <button type="button" class="btn btn-primary btn-sm ml-3 mb-3" data-toggle="modal" data-target="#donasiModal" wire:click="createDonasi"><i class="fas fa-plus mr-1"></i>Tambah Donasi</button>
                </div>
